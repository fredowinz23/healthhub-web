...
<br>
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Specialty</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a class="text-muted " href="">Settings</a></li>
                      <li class="breadcrumb-item" aria-current="page">Specialty</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
              ...
              <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                  <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-info d-flex align-items-center">
                    <i class="ti ti-users text-white me-1 fs-5"></i> Add Specialty
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <form action="process.php?action=specialty-save" id="addContactModalTitle" method="post">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="action-btn">
                          ...
                          <a href="process.php?action=specialty-delete&Id=<?=$row->Id?>" class="text-dark ms-2">
          ...
          <script src="<?=$ROOT_DIR;?>pages/js/specialty.js"></script>
